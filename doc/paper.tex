...
\englishabstract{This paper describes a program for creation and visualization of a Conway’s Game of Life variant, where a board consists of Voronoi diagrams. The project consist of the following three components:
a Voronoi diagrams generator using Fortune’s algorithm,
a game visualization engine using OpenGl API,
and a game description language evaluator.}
